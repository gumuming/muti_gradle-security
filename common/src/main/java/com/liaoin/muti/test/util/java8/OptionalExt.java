package com.liaoin.muti.test.util.java8;
...
public final class OptionalExt<T> {
    ...
    /**
     * Return the contained value, if present, otherwise throw an com.liaoin.service.core.com.liaoin.service.controller.exception
     * to be created by the provided supplier.
     *
     *  A method reference to the com.liaoin.service.core.com.liaoin.service.controller.exception constructor with an empty
     * argument list can be used as the supplier. For example,
     * {@code IllegalStateException::new}
     *
     * @param <X> Type of the com.liaoin.service.core.com.liaoin.service.controller.exception to be thrown
     * @param exceptionSupplier The supplier which will return the com.liaoin.service.core.com.liaoin.service.controller.exception to
     * be thrown
